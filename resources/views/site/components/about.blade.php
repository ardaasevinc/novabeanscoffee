                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Bringing people together, one cup at a
                                time</h2>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="about-body-list">
                            ...
                            <div class="about-body-item wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="about-body-list-content">
                                    <h3>Food delivery</h3>
                                    <p>With our fast and reliable food delivery service, your favorite coffee, snacks,
                                        and treats are just a click away.</p>
                                </div>
                            </div>
                            <!-- About Body Item End -->
                            ...
                            <div class="about-body-item wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <div class="about-body-list-content">
                                    ...
                                    <p>Host your special moments with us! From intimate gatherings to vibrant
                                        celebrations offers.</p>
                                </div>
                            </div>
                            <!-- About Body Item End -->
                        </div>
