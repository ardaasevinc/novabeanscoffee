            ...
            <div class="col-lg-6">
                <div class="contact-us-form">
                    <div class="contact-form-content">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Görüşleriniz bizim için değerli. Soru, görüş ve önerilerinizi aşağıdaki formu doldurarak bize iletebilirsiniz.</p>
                    </div>
...
<form id="laravelContactForm" action="{{ route('contact.store') }}" method="POST" class="wow fadeInUp" data-wow-delay="0.4s">
    @csrf
    <div class="row">
        ...
        <div class="form-group col-md-12 mb-5">
            <textarea name="message" class="form-control" id="message" rows="3" placeholder="Mesajınız" required></textarea>
        </div>

        <div class="col-lg-12">
            <div class="contact-form-btn">
                {{-- Button type="submit" olduğundan emin ol --}}
